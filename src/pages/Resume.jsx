            ...
            <section className="mb-12">
                ...
                <div className="mb-10">
                    ...
                    <div className="relative pl-8 md:pl-12 border-l border-gray-200 dark:border-gray-700 space-y-10">
                        ...
                        <div className="relative timeline-item">
                            ...
                            <div className="text-sm text-primary mb-2 font-medium">2021 — Present</div>
                            <div className="text-gray-500 dark:text-gray-400 text-sm mb-3">Google Inc.</div>
                            <p className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed">
                                Lead development of core infrastructure services using Go and Kubernetes. Mentored junior developers and implemented CI/CD pipelines that reduced deployment time by 40%. Collaborated with cross-functional teams to define product roadmap.
                            </p>
                        </div>
                        {/* Timeline Item 2 */}
                        <div className="relative timeline-item">
                ...
                <div>
                    ...
                    <div className="relative pl-8 md:pl-12 border-l border-gray-200 dark:border-gray-700 space-y-10">
                         {/* Timeline Item 1 */}
                        <div className="relative timeline-item">
                            <h4 className="text-lg font-semibold text-gray-900 dark:text-white">Master in Computer Science</h4>
                            <div className="text-sm text-primary mb-2 font-medium">2014 — 2016</div>
                            <div className="text-sm text-gray-500 dark:text-gray-400 mb-3">Stanford University</div>
                            <p className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed">
                                Specialization in Artificial Intelligence and Machine Learning. Thesis on "Reinforcement Learning in Robotics". Graduated with Honors.
                            </p>
                        </div>
                         {/* Timeline Item 2 */}
                        <div className="relative timeline-item">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-4">
                            <div>
                                <div className="flex justify-between mb-1">
                                    ...
                                    <span className="text-sm font-medium text-gray-600 dark:text-gray-400">90%</span>
                                </div>
                            ...
                            <div>
                                <div className="flex justify-between mb-1">
                                    <span className="text-sm font-medium text-gray-600 dark:text-gray-400">Python / Django</span>
                            ...
                            <div>
                                <div className="flex justify-between mb-1">
                                    <span className="text-sm font-medium text-gray-600 dark:text-gray-400">Java</span>
                    ...
                    <div className="bg-gray-50 dark:bg-zinc-900/50 p-6 rounded-2xl border border-gray-200 dark:border-gray-800">
                        ...
                        <div className="flex flex-wrap gap-2">
                             {["Machine Learning", "Data Analysis", "Cloud Computing", "DevOps", "Agile", "UI/UX Design", "Digital Marketing"].map(skill => (
